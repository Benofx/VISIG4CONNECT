//Le manifest est hosté ici : https://static.tpionet.com/VISIG4CONNECT/extension-manifest.json
...
class App extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      mainMenu: { title: "ViSIG", icon: "https://static.tpionet.com/VISIG4CONNECT/Logo.png", command: "main_nav_menu_cliked", },
      /*subMenuItems: [
            ...
            case "extension.command":
              switch (args.data) {
                case "main_nav_menu_cliked":
                  ...
                  this.setState({ link: "https://visig.tpionet.com/webclient/html/" });
                  break;
